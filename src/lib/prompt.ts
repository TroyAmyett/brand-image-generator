...
const BRAND_THEMES: Record<BrandTheme, BrandThemeDefinition> = {
    funnelists: {
        name: "Funnelists",
        colors: {
            primary: ["electric cyan #00FFFF dominant glow", "neon lime green #39FF14 dominant glow"],
            secondary: ["neon blue #0ea5e9", "deep blue #3b82f6"],
            accent: ["purple ONLY sparingly for deep shadows or minor contrast"],
